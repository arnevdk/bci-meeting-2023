...
\begin{columns}
	...
	\block{\circled{1} Gaze-independent visual oddball interface}{
		...
		\begin{minipage}{.48\linewidth}
			The BCI target population suffers from \textcolor{black}{eye motor disabilities}. This warrants the development of gaze-independent communication paradigms. While other active BCI modalities (auditory, somatosensory, ...) can work, visual paradigms exploiting \textcolor{black}{spatial attention} often yield the highest ITR~\cite{Riccio2012}. We aim to design a visual oddball interface that can be operated efficiently by a gaze-impaired patient through accurate covert attention classification.
		\end{minipage}%
		\hfill
		\begin{minipage}{.48\linewidth}
			\centering
