\documentclass[25pt, a0paper, landscape,innermargin=1in,margin=1in]{article}
...
\newcommand*\circled[1]{\tikz[baseline=(char.base)]{%
		\node[shape=circle,fill=BlockColor,text width=1em,align=center,draw=none,text=white,inner sep=2pt] (char) {#1};}}
...
\begin{columns}
	...
	\block{2. Novel ERP latency estimation procedure}{
		...
		\bigskip
		\subsection*{ALignment improves SNR}
	...
	\block{3. Improvement in covert attention decoding}{
		...
		\subsection*{Single trial classificatin performance}
