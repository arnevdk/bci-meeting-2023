	...
	\block{\circled{2} Novel ERP latency estimation procedure}{
		...
		\begin{tikzfigure}
			\begin{tikzpicture}[
				...
				\node[right=1.5in of xcorr,fill=white,circle,draw=BlockColor, align=center](xcorr_fig){\includegraphics[width=.25\linewidth]{figures/xcorr.eps}};
		...
		\centering
		\includegraphics[width=.918\linewidth]{figures/aligned.pdf}

		\subsection*{\color{black} Convergence}
		\centering
		\includegraphics[width=.918\linewidth]{figures/convergence.eps}
	}
